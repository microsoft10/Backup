            ...
            if (GetValue<bool>(mode, "Q"))
            {
                ...
                if (target != null &&
                    ((Player.Distance(target) > Q.Range - 100 && !target.IsFacing(Player) && Player.IsFacing(target)) ||
                     target.HealthPercent > 60) && Q.CastOnUnit(target, PacketCast))
                {
                    return;
                }
            }
                    ...
                    var obj =
                        HeroManager.Allies.Where(
                            i =>
                                ...
                                i.HealthPercent < GetValue<Slider>("Heal", MenuName(i) + "HpU").Value &&
                    ...
                    var obj =
                        HeroManager.Allies.Where(
                            i =>
                                ...
                                i.HealthPercent < GetValue<Slider>("Save", MenuName(i) + "HpU").Value &&
